...
def calls(call):
    if call.data == "en":
        ...
        keyboard = types.InlineKeyboardMarkup()
        c1 = types.InlineKeyboardButton(config.my.cost_50, callback_data="c1")
        c2 = types.InlineKeyboardButton(config.my.cost_60, callback_data="c2")
        c3 = types.InlineKeyboardButton(config.my.cost_70, callback_data="c3")
        c4 = types.InlineKeyboardButton(config.my.cost_80, callback_data="c4")
        c5 = types.InlineKeyboardButton(config.my.cost_90, callback_data="c5")
        c6 = types.InlineKeyboardButton(config.my.cost_100, callback_data="c6")
        back = types.InlineKeyboardButton(config.my.back, callback_data='home')
